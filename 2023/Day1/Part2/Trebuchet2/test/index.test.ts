...
describe("identifyNumbers", () => {
  it("should return 12", () => {
    let result = identifyNumbers("1abc2");
  ...
  it("should return 77", () => {
    let result = identifyNumbers("vttq7sixninekgxtpspjgkninesnpktchz");
    assert.equal(result, 77);
  });
  it("should return 33", () => {
    let result = identifyNumbers("sixfive3nine57sevenvqbtsh3");
...
describe("decipher", () => {
  ...
  3eighteightllkbxkbs9zgznxtj8lfflcst`;
    let result = decipherPt1(urlInput);
    assert.equal(result, 55834);
  });
});
...
describe("identifyNumbersPt2", () => {
  it("should return 27", () => {
    const result = identifyNumbersPt2("29lzrxseven");
    assert.equal(result, 27);
  });
  it("should return 96", () => {
    const result = identifyNumbersPt2("9nnqljsixkzphvtmtr");
    assert.equal(result, 96);
  });
  it("should return 52", () => {
    const result = identifyNumbersPt2("five73kskpfgbkcltwoccvf");
    assert.equal(result, 52);
  });
  it("should return 55", () => {
    const result = identifyNumbersPt2("five");
  ...
  it("should return 55", () => {
    const result = identifyNumbersPt2("5hefuhwefhwfoiuh");
    assert.equal(result, 55);
  });
});

describe("decipherPt2", () => {
  ...
  7two5one8
  3eighteightllkbxkbs9zgznxtj8lfflcst`;
    let result = decipherPt2(urlInput);
    assert.equal(result, 53221);
  });
});
