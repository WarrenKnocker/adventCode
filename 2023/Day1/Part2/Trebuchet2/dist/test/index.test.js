...
(0, mocha_1.describe)("identifyNumbers", () => {
    it("should return 12", () => {
        let result = (0, index_ts_1.identifyNumbers)("1abc2");
        chai_1.assert.equal(result, 12);
    });
    it("should return 29", () => {
        let result = (0, index_ts_1.identifyNumbers)("29lzrxseven");
        chai_1.assert.equal(result, 29);
    });
    it("should return 77", () => {
        let result = (0, index_ts_1.identifyNumbers)("vttq7sixninekgxtpspjgkninesnpktchz");
        chai_1.assert.equal(result, 77);
    });
    it("should return 33", () => {
        let result = (0, index_ts_1.identifyNumbers)("sixfive3nine57sevenvqbtsh3");
        chai_1.assert.equal(result, 33);
    });
});
(0, mocha_1.describe)("decipher", () => {
    it("should return 142", () => {
        let result = (0, index_ts_1.decipherPt1)("1abc2\npqr3stu8vwx\na1b2c3d4e5f\ntreb7uchet");
        chai_1.assert.equal(result, 142);
    });
    it("should return 55834", () => {
        let urlInput = `29lzrxseven
  9nnqljsixkzphvtmtr
  ...
  3eighteightllkbxkbs9zgznxtj8lfflcst`;
        let result = (0, index_ts_1.decipherPt1)(urlInput);
        chai_1.assert.equal(result, 55834);
    });
});
//=================================
// Part 2
(0, mocha_1.describe)("identifyNumbersPt2", () => {
    it("should return 27", () => {
        const result = (0, index_ts_1.identifyNumbersPt2)("29lzrxseven");
        chai_1.assert.equal(result, 27);
    });
    it("should return 96", () => {
        const result = (0, index_ts_1.identifyNumbersPt2)("9nnqljsixkzphvtmtr");
        chai_1.assert.equal(result, 96);
    });
    it("should return 52", () => {
        const result = (0, index_ts_1.identifyNumbersPt2)("five73kskpfgbkcltwoccvf");
        chai_1.assert.equal(result, 52);
    });
    it("should return 55", () => {
        const result = (0, index_ts_1.identifyNumbersPt2)("five");
    ...
    it("should return 55", () => {
        const result = (0, index_ts_1.identifyNumbersPt2)("5hefuhwefhwfoiuh");
        chai_1.assert.equal(result, 55);
    });
});
(0, mocha_1.describe)("decipherPt2", () => {
    it("should return 53221", () => {
        let urlInput = `29lzrxseven
  9nnqljsixkzphvtmtr
  five73kskpfgbkcltwoccvf
  fiveq7
  ...
  7two5one8
  3eighteightllkbxkbs9zgznxtj8lfflcst`;
        let result = (0, index_ts_1.decipherPt2)(urlInput);
        chai_1.assert.equal(result, 53221);
    });
});
